      ...
      NIS_radar_(7.815)
{
  ...
  static const float NOISE_RHO = 0.3;
  static const float NOISE_PHI = 0.03;
  static const float NOISE_RD = 0.3;
...
void UKF::UpdateLidar(const MeasurementPackage meas_package)
{
  ...
  UpdateLidar_CalculateNIS(z, z_pred, S);
}

//******************************************************************************
void UKF::UpdateLidar_CalculateNIS(const VectorXd& z, const VectorXd& z_pred,
                                   const MatrixXd& S)
{
